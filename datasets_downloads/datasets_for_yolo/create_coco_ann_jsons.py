...
def create_coco_ann_json(base_dataset_folder, video_list, annotation_list, json_output_file,
        ...
        for c_xml in xml_to_be_used:
            ...
            for cbox in c_data['boxes']:
                ...
                data['annotations'].append({'segmentation': [[l, t, r, t, r, b, l, b]], 'area': area,
                                            'iscrowd': 0, 'image_id': c_data['img_name'].split(".")[0], 'unique_id': cbox['unique_id'],
...
if __name__ == "__main__":
    ...
    NUM_TRAIN_VIDEOS_PER_SET = 5  # the first 10 videos for each set will go in the train set
    ...
    # List of test directories to create
    ...
    for name in test_names:
        ...
        create_coco_ann_json(base_dataset_folder, video_list_test, annotation_list_test,
                             json_output_file_test, negative_ratio=negative_ratio,
    ...
    test_names = ["test_real_colon_all", "test_real_colon_min_train"]

    # Create test folders and populate
    for name in test_names:
        NUM_TRAIN_VIDEOS_PER_SET = 0
        if name == "test_real_colon_min_train":
        ...
        create_coco_ann_json(base_dataset_folder, video_list_test, annotation_list_test,
                             json_output_file_test, negative_ratio=negative_ratio,
                             num_positives_per_lesions=num_positives_per_lesions)
        print(f"Testing conversion completed")
